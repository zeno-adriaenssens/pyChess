...
class ChessGame:
    ...
    def load_images(self):
        self.king1 = image.load("images/wking.png").convert_alpha()
        self.king2 = image.load("images/bking.png").convert_alpha()
        self.pawn1 = image.load("images/wpawn.png").convert_alpha()
        self.pawn2 = image.load("images/bpawn.png").convert_alpha()
        self.rook1 = image.load("images/wrook.png").convert_alpha()
        self.rook2 = image.load("images/brook.png").convert_alpha()
        self.queen1 = image.load("images/wqueen.png").convert_alpha()
        self.queen2 = image.load("images/bqueen.png").convert_alpha()
        self.bishop1 = image.load("images/wbishop.png").convert_alpha()
        self.bishop2 = image.load("images/bbishop.png").convert_alpha()
        self.knight1 = image.load("images/wknight.png").convert_alpha()
        self.knight2 = image.load("images/bknight.png").convert_alpha()

    def create_board(self):
        self.font1 = font.Font('fonts/Alido.otf',18)
        self.font2 = font.Font('fonts/LCALLIG.ttf',36)
